...
if direction_lower == "left":
    ...
    if lake_lower == "wait":
        ...
        island_door_lower = island_door.lower()
        if island_door_lower == "blue":
            print("You found the treasure. You win!")
        elif island_door_lower == "red":
            print("You enter a room to hell. Game over!")
        else:
            print("You enter a room of beasts. Game over!")
    else:
        print("You are eaten by the shark. Game over!")
else:
